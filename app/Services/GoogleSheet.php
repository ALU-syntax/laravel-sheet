...
class GoogleSheet{
    ...
    public function __construct() {
        $this->spreadSheetId = config("laravelsheet.google_sheet_id");
    ...
    public function readGoogleSheet(){
        ...
        $data = $this->googleSheetService->spreadsheets_values->batchGet($this->spreadSheetId, ['ranges' => $range, 'majorDimension' => 'ROWS']);
